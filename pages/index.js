    ...
    <div>
      ...
      <main className="min-h-[70vh] flex items-center">
        <div className="max-w-5xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 gap-12">
          <section className="flex flex-col justify-center">
            ...
            <h1 className="text-2xl md:text-3xl font-extrabold mb-4">読むだけは、もう卒業。</h1>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-4 sm:space-y-0 mb-8">
              <a className="btn-red-blue px-6 py-3 rounded-md text-white flex flex-col items-center text-center" href="#contact">
                <span className="text-base">入部届を送る</span>
                <span className="text-xs opacity-90">（仮入部・無料）</span>
              </a>
              <a className="btn-blue px-6 py-3 rounded-md text-white flex flex-col items-center text-center" href="#contact">
                <span className="text-base">まずは部活見学</span>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold">지금 시작해요！</h2>
        </div>
      </section>
